 ...
 */
static  uint16_t mavlink_msg_gps_date_time_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint8_t year, uint8_t month, uint8_t day, uint8_t hour, uint8_t min, uint8_t sec, uint8_t visSat)
{
	uint16_t i = 0;
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static  uint16_t mavlink_msg_gps_date_time_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, uint8_t year, uint8_t month, uint8_t day, uint8_t hour, uint8_t min, uint8_t sec, uint8_t visSat)
{
	uint16_t i = 0;
	msg->msgid = MAVLINK_MSG_ID_GPS_DATE_TIME;
 ...
 */
static  uint16_t mavlink_msg_gps_date_time_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_gps_date_time_t* gps_date_time)
{
...
static  void mavlink_msg_gps_date_time_send(mavlink_channel_t chan, uint8_t year, uint8_t month, uint8_t day, uint8_t hour, uint8_t min, uint8_t sec, uint8_t visSat)
{
 ...
 */
static  uint8_t mavlink_msg_gps_date_time_get_year(const mavlink_message_t* msg)
{
 ...
 */
static  uint8_t mavlink_msg_gps_date_time_get_month(const mavlink_message_t* msg)
{
 ...
 */
static  uint8_t mavlink_msg_gps_date_time_get_day(const mavlink_message_t* msg)
{
 ...
 */
static  uint8_t mavlink_msg_gps_date_time_get_hour(const mavlink_message_t* msg)
{
 ...
 */
static  uint8_t mavlink_msg_gps_date_time_get_min(const mavlink_message_t* msg)
{
 ...
 */
static  uint8_t mavlink_msg_gps_date_time_get_sec(const mavlink_message_t* msg)
{
 ...
 */
static  uint8_t mavlink_msg_gps_date_time_get_visSat(const mavlink_message_t* msg)
{
 ...
 */
static  void mavlink_msg_gps_date_time_decode(const mavlink_message_t* msg, mavlink_gps_date_time_t* gps_date_time)
{
