 ...
 */
static  uint16_t mavlink_msg_gps_raw_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint64_t usec, uint8_t fix_type, float lat, float lon, float alt, float eph, float epv, float v, float hdg)
{
	uint16_t i = 0;
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static  uint16_t mavlink_msg_gps_raw_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, uint64_t usec, uint8_t fix_type, float lat, float lon, float alt, float eph, float epv, float v, float hdg)
{
	uint16_t i = 0;
	msg->msgid = MAVLINK_MSG_ID_GPS_RAW;
 ...
 */
static  uint16_t mavlink_msg_gps_raw_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_gps_raw_t* gps_raw)
{
...
static  void mavlink_msg_gps_raw_send(mavlink_channel_t chan, uint64_t usec, uint8_t fix_type, float lat, float lon, float alt, float eph, float epv, float v, float hdg)
{
 ...
 */
static  uint64_t mavlink_msg_gps_raw_get_usec(const mavlink_message_t* msg)
{
	generic_64bit r;
	r.b[7] = (msg->payload)[0];
	r.b[6] = (msg->payload)[1];
 ...
 */
static  uint8_t mavlink_msg_gps_raw_get_fix_type(const mavlink_message_t* msg)
{
 ...
 */
static  float mavlink_msg_gps_raw_get_lat(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 */
static  float mavlink_msg_gps_raw_get_lon(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 */
static  float mavlink_msg_gps_raw_get_alt(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 * @return GPS HDOP
 */
static  float mavlink_msg_gps_raw_get_eph(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 * @return GPS VDOP
 */
static  float mavlink_msg_gps_raw_get_epv(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 */
static  float mavlink_msg_gps_raw_get_v(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 */
static  float mavlink_msg_gps_raw_get_hdg(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 */
static  void mavlink_msg_gps_raw_decode(const mavlink_message_t* msg, mavlink_gps_raw_t* gps_raw)
{
