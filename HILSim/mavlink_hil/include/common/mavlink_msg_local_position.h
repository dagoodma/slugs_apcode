 ...
 */
static  uint16_t mavlink_msg_local_position_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint64_t usec, float x, float y, float z, float vx, float vy, float vz)
{
	uint16_t i = 0;
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static  uint16_t mavlink_msg_local_position_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, uint64_t usec, float x, float y, float z, float vx, float vy, float vz)
{
	uint16_t i = 0;
	msg->msgid = MAVLINK_MSG_ID_LOCAL_POSITION;
 ...
 */
static  uint16_t mavlink_msg_local_position_encode(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, const mavlink_local_position_t* local_position)
{
...
static  void mavlink_msg_local_position_send(mavlink_channel_t chan, uint64_t usec, float x, float y, float z, float vx, float vy, float vz)
{
 ...
 */
static  uint64_t mavlink_msg_local_position_get_usec(const mavlink_message_t* msg)
{
	generic_64bit r;
	r.b[7] = (msg->payload)[0];
	r.b[6] = (msg->payload)[1];
 ...
 * @return X Position
 */
static  float mavlink_msg_local_position_get_x(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 * @return Y Position
 */
static  float mavlink_msg_local_position_get_y(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 * @return Z Position
 */
static  float mavlink_msg_local_position_get_z(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 * @return X Speed
 */
static  float mavlink_msg_local_position_get_vx(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 * @return Y Speed
 */
static  float mavlink_msg_local_position_get_vy(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 * @return Z Speed
 */
static  float mavlink_msg_local_position_get_vz(const mavlink_message_t* msg)
{
	generic_32bit r;
 ...
 */
static  void mavlink_msg_local_position_decode(const mavlink_message_t* msg, mavlink_local_position_t* local_position)
{
