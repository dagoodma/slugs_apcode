...
static  mavlink_status_t* mavlink_get_channel_status(uint8_t chan)
{
 ...
 */
static  uint16_t mavlink_finalize_message(mavlink_message_t* msg, uint8_t system_id, uint8_t component_id, uint16_t length)
{
 ...
 * @param length Message length, usually just the counter incremented while packing the message
 */
static  uint16_t mavlink_finalize_message_chan(mavlink_message_t* msg, uint8_t system_id, uint8_t component_id, uint8_t chan, uint16_t length)
{
	// This code part is the same for all messages;
	uint16_t checksum;
	msg->len = length;
 ...
 */
static  uint16_t mavlink_msg_to_send_buffer(uint8_t* buffer, const mavlink_message_t* msg)
{
...
static  void mavlink_start_checksum(mavlink_message_t* msg)
{
	union checksum_ ck;
	crc_init(&(ck.s));
	msg->ck_a = ck.c[0];
...
static  void mavlink_update_checksum(mavlink_message_t* msg, uint8_t c)
{
	union checksum_ ck;
	ck.c[0] = msg->ck_a;
	ck.c[1] = msg->ck_b;
...
static  uint8_t mavlink_parse_char(uint8_t chan, uint8_t c, mavlink_message_t* r_message, mavlink_status_t* r_mavlink_status)
{
	...
	rxmsg = &m_mavlink_message[chan]; ///< The currently decoded message
	status = mavlink_get_channel_status(chan); ///< The current decode status
...
/*
static  uint8_t mavlink_parse_char_new(uint8_t chan, uint8_t c, mavlink_message_t* r_message, mavlink_status_t* r_mavlink_status)
{
	    static mavlink_status_t m_mavlink_status[MAVLINK_COMM_NUM_BUFFERS];
 ...
 */
static  uint8_t put_uint8_t_by_index(uint8_t b, uint8_t bindex, uint8_t* buffer)
{
	*(buffer + bindex) = b;
	return sizeof(b);
}
 ...
 * @return the new position of the last used byte in the buffer
 */
static  uint8_t put_int8_t_by_index(int8_t b, int8_t bindex, uint8_t* buffer)
{
 ...
 * @return the new position of the last used byte in the buffer
 */
static  uint8_t put_uint16_t_by_index(uint16_t b, const uint8_t bindex, uint8_t* buffer)
{
 ...
 * @return the new position of the last used byte in the buffer
 */
static  uint8_t put_int16_t_by_index(int16_t b, uint8_t bindex, uint8_t* buffer)
{
 ...
 * @return the new position of the last used byte in the buffer
 */
static  uint8_t put_uint32_t_by_index(uint32_t b, const uint8_t bindex, uint8_t* buffer)
{
 ...
 * @return the new position of the last used byte in the buffer
 */
static  uint8_t put_int32_t_by_index(int32_t b, uint8_t bindex, uint8_t* buffer)
{
	buffer[bindex]   = (b>>24)&0xff;
	buffer[bindex+1] = (b>>16)&0xff;
	buffer[bindex+2] = (b>>8)&0xff;
 ...
 * @return the new position of the last used byte in the buffer
 */
static  uint8_t put_uint64_t_by_index(uint64_t b, const uint8_t bindex, uint8_t* buffer)
{
 ...
 * @return the new position of the last used byte in the buffer
 */
static  uint8_t put_int64_t_by_index(int64_t b, uint8_t bindex, uint8_t* buffer)
{
 ...
 * @return the new position of the last used byte in the buffer
 */
static  uint8_t put_float_by_index(float b, uint8_t bindex, uint8_t* buffer)
{
	generic_32bit g;
	g.f = b;
 ...
 */
static  uint8_t put_array_by_index(const int8_t* b, uint8_t length, uint8_t bindex, uint8_t* buffer)
{
 ...
 * @return new position of the last used byte in the buffer
 */
static  uint8_t put_string_by_index(const char* b, uint8_t maxlength, uint8_t bindex, uint8_t* buffer)
{
	uint16_t length = 0;
 ...
 * @return new position of the last used byte in the buffer
 */
static  uint8_t put_bitfield_n_by_index(int32_t b, uint8_t bits, uint8_t packet_index, uint8_t bit_index, uint8_t* r_bit_index, uint8_t* buffer)
{
...
static  void mavlink_send_uart_uint8_t(mavlink_channel_t chan, uint8_t b, uint16_t* checksum)
{
	crc_accumulate(b, checksum);
	comm_send_ch(chan, b);
}

static  void mavlink_send_uart_int8_t(mavlink_channel_t chan, int8_t b, uint16_t* checksum)
{
	crc_accumulate(b, checksum);
	comm_send_ch(chan, b);
}

static  void mavlink_send_uart_uint16_t(mavlink_channel_t chan, uint16_t b, uint16_t* checksum)
{
	char s;
	s = (b>>8)&0xff;
	comm_send_ch(chan, s);
...
static  void mavlink_send_uart_int16_t(mavlink_channel_t chan, int16_t b, uint16_t* checksum)
{
	mavlink_send_uart_uint16_t(chan, b, checksum);
}

static  void mavlink_send_uart_uint32_t(mavlink_channel_t chan, uint32_t b, uint16_t* checksum)
{
	char s;
	s = (b>>24)&0xff;
	comm_send_ch(chan, s);
...
static  void mavlink_send_uart_int32_t(mavlink_channel_t chan, int32_t b, uint16_t* checksum)
{
	mavlink_send_uart_uint32_t(chan, b, checksum);
}

static  void mavlink_send_uart_uint64_t(mavlink_channel_t chan, uint64_t b, uint16_t* checksum)
{
	char s;
	s = (b>>56)&0xff;
	comm_send_ch(chan, s);
...
static  void mavlink_send_uart_int64_t(mavlink_channel_t chan, int64_t b, uint16_t* checksum)
{
	mavlink_send_uart_uint64_t(chan, b, checksum);
}

static  void mavlink_send_uart_float_t(mavlink_channel_t chan, float b, uint16_t* checksum)
{
	generic_32bit g;
	g.f = b;
...
static  void mavlink_send_uart_double_t(mavlink_channel_t chan, double b, uint16_t* checksum)
{
	generic_64bit g;
	g.d = b;
...
static  void mavlink_send_uart(mavlink_channel_t chan, mavlink_message_t* msg)
{
