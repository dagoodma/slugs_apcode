...
#
ADD_INCLUDES = \
	-IC:\Users\dagoodma\Documents\asl\slugs_apcode\sensorMCUSlugsMKII_dspic\sources \
	-IC:\Users\dagoodma\Documents\asl\slugs_apcode \
	-IC:\Users\dagoodma\Documents\asl\slugs_apcode\..\mavlink\include\slugs \
	-IC:\Users\dagoodma\Documents\asl\slugs_apcode\clib \
...
%.o : C:\Users\dagoodma\Documents\asl\slugs_apcode\clib/%.c
	$(CC) -c $(CFLAGS) $<
%.o : $(MATLAB_ROOT)\rtw\c\src/%.c
	$(CC) -c $(CFLAGS) $<


%.o : C:\Users\dagoodma\Documents\asl\slugs_apcode\clib/%.cpp
	$(CC) -c $(CPPFLAGS) $<
%.o : $(MATLAB_ROOT)\rtw\c\src/%.cpp
	$(CC) -c $(CPPFLAGS) $<


%.o : C:\Users\dagoodma\Documents\asl\slugs_apcode\clib/%.s
	$(CC) -c $< -Wa,-p=$(PIC_REF),-g
