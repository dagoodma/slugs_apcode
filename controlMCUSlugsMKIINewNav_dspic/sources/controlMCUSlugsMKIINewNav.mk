#
# File: controlMCUSlugsMKIINewNav.mk
#
#--------------------------------------------------------------
...
#   
MODEL               = controlMCUSlugsMKIINewNav
MODULES             = DEE.c DEES.s FCBEX1000.c apUtils.c circBuffer.c controlMCUSlugsMKIINewNav_data.c controlMCUSlugsMKIINewNav_main.c dsPIC_InputCapture_Interrupt.c eepLoader.c interProcCommSlave.c mavlinkCommsControlMcu.c mavlinkControlMcu.c navSupport.c rtGetInf.c rtGetNaN.c rt_nonfinite.c updateControlMcuState.c 
MAKEFILE            = controlMCUSlugsMKIINewNav.mk
...
MODELLIB                  = controlMCUSlugsMKIINewNavlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
#
ADD_INCLUDES = \
	-IC:\Users\dagoodma\Documents\asl\slugs_apcode_fresh\controlMCUSlugsMKIINewNav_dspic\sources \
